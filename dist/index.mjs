...
var require_termux = __commonJS({
  "node_modules/clipboardy/lib/termux.js"(exports, module) {
    "use strict";
    ...
    module.exports = {
      copy: (options) => __async(exports, null, function* () {
        try {
      ...
      paste: (options) => __async(exports, null, function* () {
        try {
...
var require_linux = __commonJS({
  "node_modules/clipboardy/lib/linux.js"(exports, module) {
    "use strict";
    var path = __require("path");
    var execa = require_execa();
    var xsel = "xsel";
    ...
    var xselWithFallback = (argumentList, options) => __async(exports, null, function* () {
      try {
...
var require_macos = __commonJS({
  "node_modules/clipboardy/lib/macos.js"(exports, module) {
    "use strict";
    var execa = require_execa();
...
var require_arch = __commonJS({
  "node_modules/arch/index.js"(exports, module) {
    "use strict";
    var cp = __require("child_process");
    var fs = __require("fs");
    var path = __require("path");
...
var require_windows2 = __commonJS({
  "node_modules/clipboardy/lib/windows.js"(exports, module) {
    "use strict";
    var path = __require("path");
    var execa = require_execa();
...
var require_clipboardy = __commonJS({
  "node_modules/clipboardy/index.js"(exports) {
    ...
    exports.write = (text) => __async(exports, null, function* () {
      if (typeof text !== "string") {
        throw new TypeError(`Expected a string, got ${typeof text}`);
      }
      yield platformLib.copy({ input: text });
    });
    exports.read = () => __async(exports, null, function* () {
  ...
  return __async(this, null, function* () {
    if (process.argv.length < 3) {
      ...
      while (true) {
        ...
        let verification = yield verify(txHex);
